...
public class OBDUpdateThread extends Thread {
	public static enum Priority {
		OBD_PRIORITY_HIGH, OBD_PRIORITY_MEDIUM, OBD_PRIORITY_LOW, OBD_PRIORITY_FF
	}
	...
	private final HashMap<Byte, HashSet<OBDListener>> pids = 
			new HashMap<Byte, HashSet<OBDListener>>();
	BitSet pid_map;
	...
	public void addListener(final Priority priority, final byte pid,
			final OBDListener listener) {
