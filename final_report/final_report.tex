...
\begin{itemize}
\item Build and then unit test the Bluetooth module
\begin{figure}[H]
\centering
...
\item Build then unit test the MCU
\begin{figure}[H]
\centering
...
\item Build then unit test a subset of the power supply
\begin{figure}[H]
\centering
...
\item Build then unit test the 5 protocols required for OBD-II
\begin{figure}[H]
\centering
